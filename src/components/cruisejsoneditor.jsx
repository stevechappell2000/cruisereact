...
/*
 * CruiseJsonEditor Component
 */
let CruiseJsonEditor = React.createClass({
  ...
  render() {
    ...
    return (
      <div>
        <div>JsonIn: {this.props.JsonIn}</div>
      </div>
    );
  }
});

export default CruiseJsonEditor;
