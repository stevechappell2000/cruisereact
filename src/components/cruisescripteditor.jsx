...
/*
 * CruiseScriptEditor Component
 */
let CruiseScriptEditor = React.createClass({
   ...
   */
  propTypes: {
    ScriptIn: React.PropTypes.string
  },
  ...
  render() {
    ...
    return (
      <div>
        <div>ScriptIn: {this.props.ScriptIn}</div>
      </div>
    );
  }
});

export default CruiseScriptEditor;
