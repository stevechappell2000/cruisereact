...
/*
 * CruiseFormEditor Component
 */
let CruiseFormEditor = React.createClass({
  ...
  render() {
    ...
    return (
      <div>
        <div>FormIn: {this.props.FormIn}</div>
      </div>
    );
  }
});

export default CruiseFormEditor;
